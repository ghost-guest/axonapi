  ...
  const rawNavGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        {
          title: t('sidebar.items.publicBenefit'),
          url: '/public-benefit',
          icon: IconActivity,
        } as NavLink,
        {
          title: t('sidebar.items.publicBenefitProviders'),
          url: '/public-benefit-providers',
          icon: IconKey,
        } as NavLink,
        {
          title: t('sidebar.items.publicBenefitOutbound'),
          url: '/public-benefit-outbound',
          icon: IconSettings,
        } as NavLink,
        {
