...
type Handlers struct {
	...
	PublicBenefit  *api.PublicBenefitHandlers
}
...
func SetupRoutes(server *Server, handlers Handlers, client *ent.Client, services Services) {
	...
	// 管理员路由 - 使用 JWT 认证
	{
		...
		adminGroup.GET("/public-benefit/config", handlers.PublicBenefit.GetConfig)
		adminGroup.PUT("/public-benefit/config", handlers.PublicBenefit.UpdateConfig)
		adminGroup.GET("/public-benefit/runtime", handlers.PublicBenefit.GetRuntime)
		adminGroup.PUT("/public-benefit/runtime", handlers.PublicBenefit.UpdateRuntime)
		adminGroup.GET("/public-benefit/dashboard", handlers.PublicBenefit.GetDashboard)
		adminGroup.POST("/public-benefit/sync", handlers.PublicBenefit.TriggerSync)
		adminGroup.POST("/public-benefit/providers/parse-identity", handlers.PublicBenefit.ParseProviderIdentity)
		adminGroup.POST("/public-benefit/providers/:provider_id/refresh", handlers.PublicBenefit.RefreshProvider)
		adminGroup.POST("/public-benefit/providers/:provider_id/checkin", handlers.PublicBenefit.CheckInProvider)
		adminGroup.POST("/public-benefit/upstreams/:upstream_id/refresh", handlers.PublicBenefit.RefreshUpstream)
	}
