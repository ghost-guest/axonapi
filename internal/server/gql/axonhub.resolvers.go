...
// ProbeFrequency is the resolver for the probeFrequency field.
func (r *channelSettingsResolver) ProbeFrequency(ctx context.Context, obj *objects.ChannelSettings) (*string, error) {
	if obj == nil || obj.ProbeFrequency == "" {
		value := ""
		return &value, nil
	}

	value := string(obj.ProbeFrequency)

	return &value, nil
}

// ProbeIntervalMode is the resolver for the probeIntervalMode field.
func (r *channelSettingsResolver) ProbeIntervalMode(ctx context.Context, obj *objects.ChannelSettings) (*string, error) {
	if obj == nil || obj.ProbeIntervalMode == "" {
		value := ""
		return &value, nil
	}

	value := string(obj.ProbeIntervalMode)

	return &value, nil
}

// ProbeFixedIntervalSeconds is the resolver for the probeFixedIntervalSeconds field.
func (r *channelSettingsResolver) ProbeFixedIntervalSeconds(ctx context.Context, obj *objects.ChannelSettings) (*int, error) {
	if obj == nil || obj.ProbeFixedIntervalSeconds <= 0 {
		return nil, nil
	}

	value := obj.ProbeFixedIntervalSeconds
	return &value, nil
}

// ProbeRandomMinIntervalSeconds is the resolver for the probeRandomMinIntervalSeconds field.
func (r *channelSettingsResolver) ProbeRandomMinIntervalSeconds(ctx context.Context, obj *objects.ChannelSettings) (*int, error) {
	if obj == nil || obj.ProbeRandomMinIntervalSeconds <= 0 {
		return nil, nil
	}

	value := obj.ProbeRandomMinIntervalSeconds
	return &value, nil
}

// ProbeRandomMaxIntervalSeconds is the resolver for the probeRandomMaxIntervalSeconds field.
func (r *channelSettingsResolver) ProbeRandomMaxIntervalSeconds(ctx context.Context, obj *objects.ChannelSettings) (*int, error) {
	if obj == nil || obj.ProbeRandomMaxIntervalSeconds <= 0 {
		return nil, nil
	}

	value := obj.ProbeRandomMaxIntervalSeconds
	return &value, nil
}
...
// ProbeFrequency is the resolver for the probeFrequency field.
func (r *channelSettingsInputResolver) ProbeFrequency(ctx context.Context, obj *objects.ChannelSettings, data *string) error {
	if data == nil || *data == "" {
		obj.ProbeFrequency = ""
		return nil
	}

	obj.ProbeFrequency = objects.ChannelProbeFrequency(*data)

	return nil
}

// ProbeIntervalMode is the resolver for the probeIntervalMode field.
func (r *channelSettingsInputResolver) ProbeIntervalMode(ctx context.Context, obj *objects.ChannelSettings, data *string) error {
	if data == nil || *data == "" {
		obj.ProbeIntervalMode = ""
		return nil
	}

	obj.ProbeIntervalMode = objects.ChannelProbeIntervalMode(*data)
